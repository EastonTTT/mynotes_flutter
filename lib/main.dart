...
void main() {
  ...
  runApp(MaterialApp(title: 'Flutter Demo', home: HomePage()));
}
            ...
            return Column(
              children: [
                ...
                Visibility(
                  ...
                  child: Text('$invalidValue is not a valid number'),
                ),
                TextField(
...
class CounterStateInvalidNumber extends CounterState {
  final String invaliValue;
  const CounterStateInvalidNumber({
    required this.invaliValue,
